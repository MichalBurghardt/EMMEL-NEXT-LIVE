...
const navigation = [
  ...
  { name: 'Fleet', href: '/fleet', icon: FleetIcon },
...
export default function MainLayout({ children }: MainLayoutProps) {
  ...
  // Check if the path matches the navigation item
  ...
  return (
    <AuthProvider>
      <div className="flex h-screen bg-gray-50 dark:bg-gray-900">
        ...
        {/* Mobile sidebar */}
        <div
          className={`fixed inset-y-0 left-0 z-50 w-64 transform bg-white dark:bg-gray-800 transition-transform duration-300 ease-in-out md:hidden ${
            sidebarOpen ? 'translate-x-0' : '-translate-x-full'
          }`}
        >
          <div className="flex h-16 items-center justify-between px-4 border-b dark:border-gray-700">
            <div className="text-xl font-semibold text-gray-800 dark:text-white">Emmel Bus</div>
            <button
              type="button"
        ...
        <div className="md:pl-64 flex flex-col flex-1">
          ...
          <div className="sticky top-0 z-10 bg-white dark:bg-gray-800 border-b dark:border-gray-700">
            <div className="px-4 flex h-16 items-center justify-between md:justify-end">
              <div className="text-xl font-semibold text-gray-800 dark:text-white md:hidden">Emmel Bus</div>
